 ...
 */
final class Version20210124023537 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE academic_training DROP FOREIGN KEY FK_EA220298A76ED395');
        $this->addSql('ALTER TABLE academic_training ADD CONSTRAINT FK_EA220298A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE academic_training DROP FOREIGN KEY FK_EA220298A76ED395');
        $this->addSql('ALTER TABLE academic_training ADD CONSTRAINT FK_EA220298A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE experience DROP FOREIGN KEY FK_590C103A76ED395');
        $this->addSql('ALTER TABLE experience ADD CONSTRAINT FK_590C103A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE personal_information DROP FOREIGN KEY FK_FFEF6BCCA76ED395');
        $this->addSql('ALTER TABLE personal_information ADD CONSTRAINT FK_FFEF6BCCA76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE profile DROP FOREIGN KEY FK_8157AA0FA76ED395');
